...
# buttons
settings = app.BuildKeyboard((["• Settings •", "open-settings-dex"], ["• Modules •", "asterix-dex-2"]))
...
async def _about(_, cb):
	await cb.edit_message_text(
		text=f"**Dex:** About\n\n**Location:** /home/about\n\n**[ Personal Info ]:**\n\n**Age:** {app.assistant_age}\n**Name:** {app.assistant_name}\n**Gender:** {app.assistant_gender}\n\n**[ Versions ]:**\n\n**Python:** {app.python_version}\n**Pyrogram:** {app.pyrogram_version}\n**Assistant:**  {app.assistant_version}\n\n**[ About ]:**\n\nI am Nora made by ࿇•ẞᗴᗩSԵ•࿇\nI am your friendly assistant, i will help you as much as you need. You can ask me for any help related to your userbot. If you have any suggestions or you're facing any problems which are related to asterixuserbot then just ask in [support group](https://t.me/asterixuserbot_support), ",
		reply_markup=InlineKeyboardMarkup([home_back]),
	)
	...
	await cb.edit_message_text(
		...
		reply_markup=InlineKeyboardMarkup(
			[
				[
					InlineKeyboardButton(
						"Restart bot", callback_data="restart-asterix",
					),
				],
				[
					InlineKeyboardButton(
						"Shutdown bot", callback_data="shutdown-asterix",
					)
				],
				[
					InlineKeyboardButton(
						"Update bot", callback_data="update-asterix",
					)
				],
				home_back,
			]
